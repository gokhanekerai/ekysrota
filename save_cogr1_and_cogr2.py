...
all_40 = cogr1_questions + cogr2_questions

js_content = f"""// EKYS 2027 Odaklı Soru Veritabanı - Coğrafya Video Tarama Testleri (Toplam 40 Soru)
window.EKYS_EXTRACTED_QUESTIONS = {json.dumps(all_40, ensure_ascii=False, indent=2)};
"""

with open('data/questions-db.js', 'w', encoding='utf-8') as f:
    f.write(js_content)

print(f"data/questions-db.js toplam {len(all_40)} soru ile başarıyla kaydedildi!")
