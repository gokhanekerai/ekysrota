...
class EKYSApp {
    ...
    return {
      ...
      'inkilap': {
        ...
        items: [
          ...
          {
            id: 'tarih7_direct',
            name: '📜 Genel Tarih Video Tarama Testi 7',
            icon: '📜',
            desc: 'Türk-İslam Tarihi, İlk Türk-İslam Devletleri, Hükümdarlık Alametleri ve Divanlar (20 Soru).',
            filterKey: 'tarih7',
            badge: '20 Soru Video Test'
          },
          {
            id: 'tarih8_direct',
            name: '📜 Genel Tarih Video Tarama Testi 8',
            icon: '📜',
            desc: 'Türk-İslam Kültürü, Saray Teşkilatı, İkta ve Ordu Yapısı, 2027 MEB Müfredatı (20 Soru).',
            filterKey: 'tarih8',
            badge: '20 Soru Video Test'
          },
          {
      ...
      'tarih-subtopics': {
        ...
        items: [
          ...
          {
            id: 'tarih7',
            name: 'Genel Tarih Video Tarama Testi 7 (Türk-İslam Tarihi)',
            icon: '📜',
            desc: 'İlk Türk-İslam Devletleri, Hükümdarlık Alametleri, Divanlar ve Savaşlar.',
            filterKey: 'tarih7',
            badge: '20 Soru'
          },
          {
            id: 'tarih8',
            name: 'Genel Tarih Video Tarama Testi 8 (Türk-İslam Kültürü)',
            icon: '📜',
            desc: 'Saray Teşkilatı, İkta ve Ordu Yapısı, Dil-Edebiyat ve 2027 MEB Müfredatı.',
            filterKey: 'tarih8',
            badge: '20 Soru'
          },
          {
      ...
      'egitim_bilimleri': {
        ...
        items: [
          ...
          {
            id: 'egitim_oyt_ders_3_eb',
            name: '🎓 Öğretim Teknikleri 3. Ders Soruları',
            icon: '🎓',
            desc: 'Öğretim İlkeleri (Yakından Uzağa, Yaparak Yaşayarak vb.), Sunuş & Buluş Stratejisi, Tam Öğrenme, Gagne ve Çoklu Zekâ (9 Soru • 3. Ders Özel Tarama).',
            filterKey: 'egitim_oyt_ders_3',
            badge: '9 Soru • 3. Ders'
          },
          {
            id: 'egitim_oyt_konu_eb',
            name: '🎯 Öğretim Yöntem ve Teknikleri Testi (Tümü)',
            icon: '🎯',
  ...
  getQuestionsForFilter(filterKey) {
    ...
    return allQuestions.filter(q => {
      ...
      if (filterKey === 'egitim_oyt_ders_3' || filterKey === 'egitim_oyt_3' || filterKey === 'oyt_ders_3') {
        return (q.testId === 'egitim_oyt_konu_testi' || tId === 'egitim_oyt') && (qNum >= 1 && qNum <= 9);
      }
